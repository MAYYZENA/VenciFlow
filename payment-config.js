...
const MERCADO_PAGO_CONFIG = {
    publicKey: 'TEST-1234567890123456', // 👈 COLE SUA PUBLIC KEY AQUI (COMEÇA COM APP_USR-...)
    accessToken: 'TEST-1234567890123456', // 👈 COLE SEU ACCESS TOKEN AQUI (COMEÇA COM APP_USR-...)
